...
while True:
    ...
    #rint(deltaT2)
    if deltaT2 > 100:
        if NN == 0 or NN == 1 and mover2 == 1:
            RMS = 0
        elif N!= 0: 
            RMS = math.sqrt(sum/N)
        else:
            RMS = 0
        if RMS > 0.4: #sensibilidad del brazo derecho
            
            mover = 1
            
        if NN == 0 or NN == 1 and mover4 == 1:
            RMS2 = 0
        elif N!= 0: 
            RMS2 = math.sqrt(sum2/N)
        else:
            RMS2 = 0
        if RMS2 > 0.4: #sensibilidad del brazo izquierdo
